...
function drawHeader() {
  var elFact = function elFact(type, idcn) {
  ...
  var body = document.querySelector('body');
  var navbar = elFact('div', 'navbar');
  var logo = elFact('div', 'logo');
  var logoImage = elFact('img', 'logoImage');
  logoImage.src = _assets_icon_png__WEBPACK_IMPORTED_MODULE_0__;
  logoImage.width = 80;
  var logoText1 = elFact('span', 'logoText1');
  logoText1.textContent = 'Chez';
  var logoImage2 = elFact('img', 'logoImage2');
  logoImage2.src = _assets_heart_png__WEBPACK_IMPORTED_MODULE_1__;
  logoImage2.width = 40;
  var logoText2 = elFact('span', 'logoText2');
  logoText2.textContent = 'Webpack';
  var menu = elFact('div', 'menu');
  var btn1 = elFact('button', 'btn1');
  btn1.textContent = 'Our Menu';
  var btn2 = elFact('button', 'btn2');
...
function drawLandingPage() {
  ...
  var catImgFact = function catImgFact(src) {
  ...
  var maincontent = elFact('div', 'maincontent');
  var maincontentLeft = elFact('div', 'maincontentLeft');
  var maincontentRight = elFact('div', 'maincontentRight');
  ...
  var image1 = catImgFact(_assets_cat_jpg__WEBPACK_IMPORTED_MODULE_0__);
  var image2 = catImgFact(_assets_cat2_jpg__WEBPACK_IMPORTED_MODULE_1__);
  var image3 = catImgFact(_assets_cat3_jpg__WEBPACK_IMPORTED_MODULE_2__);
  var image4 = catImgFact(_assets_cat4_jpg__WEBPACK_IMPORTED_MODULE_3__);
  var image5 = catImgFact(_assets_cat5_png__WEBPACK_IMPORTED_MODULE_4__);
...
function ourMenu() {
  ...
  var menuFact = function menuFact(idcn, innerhtml) {
